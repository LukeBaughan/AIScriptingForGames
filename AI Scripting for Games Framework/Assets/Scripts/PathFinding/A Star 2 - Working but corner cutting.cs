...
//            // Goes through each neighbor node of the current node
...
//                path.Add(new Vector2(currentNodeInfo.node.transform.position.x, currentNodeInfo.node.transform.position.y));
